    ...
    <body class="bg-gray-200 py-10">
        ...
        <div class="max-w-lg bg-white mx-auto p-5 rounded shadow">
            ...
            <form action="tags" method="POST" class="flex mb-4">
                ...
                <input type="text" name="name" id="" placeholder="Nombre de la etiqueta" class="rounded-l bg-gray-200 p-4 w-full outline-none">
                <input type="submit" value="Enviar" class="rounded-r px-8 bg-blue-500 text-white outline-none cursor-pointer">
